                ...
                for (const smo2 in SMO) {
                    for (const smo3 in SMO) {
                        for (const pmo1 in PMO) {
                            ...
                            if (optionOutput.output) {
                                
                                // Colorful console log
                                if (optionOutput.colorful) {
                                ...
                                for (const smo5 in SMO) {
                                    for (const pmo1 in PMO) {
                                        for (const pmo2 in PMO) {
                                            ...
                                            // And finally, we save the final value as expression 1. 
                                            ...
                                            // And finally, we save the final value as expression 2. 
                                            let expression2 = layerC4

                                            // Third Layer(D): Single Math Operation on Parentheses 
                                            // ----------------------------------------------------------------------------------------------------
                                            // Model(1) -> smo(x1 _ x2) _ x3
                                            // smo(layerC1) => layerD1
                                            let layerD1 = singleMathOperation(SMO[smo4], layerC1)
                                            // (layerD1) pmo2 layerB3
                                            let layerD2 = pairMathOperation(PMO[pmo2], layerD1, layerB3)
                                            // And finally, we save the final value as expression 3. 
                                            let expression3 = layerD2
                                            // ----------------------------------------------------------------------------------------------------
                                            // Model(2) -> smo( smo(x1 _ x2) _ x3)
                                            let layerD3 = singleMathOperation(SMO[smo5], layerD2)
                                            // And finally, we save the final value as expression 4. 
                                            let expression4 = layerD3
                                            // ----------------------------------------------------------------------------------------------------
                                            // Model(3) -> x1 _ smo(x2 _ x3)
                                            // smo(layerC3) => layerD6
                                            let layerD6 = singleMathOperation(SMO[smo4], layerC3)
                                            // (layerD1) pmo1 layerB1
                                            let layerD7 = pairMathOperation(PMO[pmo1], layerD6, layerB1)
                                            // And finally, we save the final value as expression 5. 
                                            let expression5 = layerD7
                                            // ----------------------------------------------------------------------------------------------------
                                            // Model(4) -> smo(x1 _ smo(x2 _ x3))
                                            let layerD8 = singleMathOperation(SMO[smo5], layerD7)
                                            // And finally, we save the final value as expression 6.
                                            let expression6 = layerD8

                                            // We display the final result in the terminal.
                                            // Colorful console log
                                            // if (optionOutputColorful) {

                                            //     // Expression1 1
                                            //     if (optionOutputNan && isNaN(expression1))
                                            //     console.log(
